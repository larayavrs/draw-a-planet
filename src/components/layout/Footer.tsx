...
export function Footer({ locale }: { locale: string }) {
  ...
  return (
    <footer className="border-t border-border-purple py-8 mt-auto">
      <div className="mx-auto max-w-[1152px] px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-text-muted">
